import Equipement from '../models/EquipementModel.js'; // Assurez-vous d'importer votre modèle Article
import mongoose from 'mongoose';

export const upvoteEquipement = async (req, res) => {
    try {
        const articleId = req.params.articleId;
        const userId = new mongoose.Types.ObjectId(req.userId);

        let article = await Equipement.findById(articleId);
        ...
        article = await Equipement.findById(articleId);
...
export const downvoteEquipement = async (req, res) => {
    try {
        const articleId = req.params.articleId;
        const userId = new mongoose.Types.ObjectId(req.userId);
